#!/bin/ksh
# This script was generated Tue May 10 13:54:58 2022 by:
#
...
pax16 -V -ignore_cf_table -scf sip.cmd -cgnd ${CAP_GROUND},1.0 -rP \
	np_rply.res,np_rME1.res,np_rME2.res,np_rME3.res,mwires.res \
	-M_perim_off -c \
...
xreduce -V -mergecap -n NET -tech \
	...
	np_rply.res,np_rME1.res,np_rME2.res,np_rME3.res,mwires.res -cap \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -nxref \
	...
	np_rME2.res np_rME3.res -rPmw mwires.mod mwires.res -ta \
