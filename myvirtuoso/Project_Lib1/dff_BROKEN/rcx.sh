#!/bin/ksh
# This script was generated Wed May  4 12:19:05 2022 by:
#
...
#	-newlvs \
#	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff.xcn \
#	-assura_run_dir \
#	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1 \
#	-assura_run_name dff -rcxdir \
#	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff \
#	-type full -temperature 25.0 -tempdir \
#	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/rcx_temp \
...
#	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/dff.sp \
...
#	@ -cap_models no -cap_ground GND -cap_extract_mode decoupled \
#	-cap_coupling_factor 1.0 -array_vias_spacing auto -xref \
#	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/dff.gnx,/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/dff.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/dff.sp
...
##RC_FREQUENCY=
##RCXDIR=/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff
##RCXFS_HIGH=N
...
##TEMPDIR=/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/dff.gnx,/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/dff.gdx
##XY_COORDINATES=
##=======================================================
...
TEMPDIR=`setTempDir /uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff
...
flattenLayers -m ME2 ME1 ply nsd psd PSUB wel polycon nsdcon psdcon pwCon \
	ptap pwCon_all ptap_all nwCon ntap VI1 PSUB_ptap_ovia wel_ntap_ovia \
...
connect -V -relocate NET np_rPSUB:np_rPSUB.conn np_rwel:np_rwel.conn \
	...
	np_rptap:np_rptap.conn np_rptap_all:np_rptap_all.conn rVI1 rpolycon \
	NG_HS_MOS_1_mgvia PG_HS_MOS_2_mgvia - PSUB_P_ptap_all_ovia,3,9 \
	PSUB_ptap_ovia,1,8 PWELL_PSUB_ovia,4,1 wel_ntap_ovia,2,7 -
...
rex -V -m -pd -I'#' -tech \
	/usr/local/cadence6/G-9FD-MIXED_MODE_RFCMOS13-1P8M-MMC_FSG_L130E_UM130FDKMFC0000OA-FDK-Ver.A02_PB/RuleDecks/Assura/G-DF-LOGIC_MIXED_MODE13-1P8M2T-FSG_TOP_METAL8K_L130E_ASSURA-LPE-1.3-P4 \
	-map p2elayermapfile -wee p2elayermapfile -N NET -rP res.mod \
	np_rply::ply_cut \
	...
	- rVI1,2,3,t rnsdcon,2,t rnwCon,2,t rpolycon,1,2,t rpsdcon,2,t \
	rpwCon,2,t rpwCon_all,2 NG_HS_MOS_1_mgvia,1,z PG_HS_MOS_2_mgvia,1,z - \
	L1T0,2,I
...
reconnect -V -n NET -s mwires.res -t NG_HS_MOS_1.trans:NG_HS_MOS_1.transr \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R me5 -b me2,me1,ply,dif,sub -t \
	me6,me7,me8,alrdl -Maxw 3 -p me3,key,me5,key 0,3.2,0 - me3_me5.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b me2,me1,ply,dif,sub -t \
	me5,me6,me7,me8,alrdl -Maxw 3 -p me3,key,me4,key 0,3.2,0 - \
	me3_me4.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R me4 -b me1,ply,dif,sub -t \
	me5,me6,me7,me8,alrdl -Maxw 3 -p me2:me2_cut,key,me4,key 0,3.2,0 - \
	me2_me4.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b me1,ply,dif,sub -t \
	me4,me5,me6,me7,me8,alrdl -Maxw 3 -p me2:me2_cut,key,me3,key 0,3.2,0 \
	- me2_me3.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R me3 -b ply,dif,sub -t \
	me4,me5,me6,me7,me8,alrdl -k me2:0.32 -Maxw 3 -p \
	me1:me1_cut,key,me3,key 0,3.2,0 - me1_me3.sip
...
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b me2,me1,ply,dif,sub -t \
	me5,me6,me7,me8,alrdl -p me3,me4 - me3_me4.sw3d
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b me1,ply,dif,sub -t \
	me4,me5,me6,me7,me8,alrdl -p me2:me2_cut,me3 - me2_me3.sw3d
...
pax16 -V -ignore_cf_table -scf sip.cmd -cgnd ${CAP_GROUND},1.0 -rP \
	np_rply.res,np_rME1.res,np_rME2.res,mwires.res -M_perim_off -c \
	...
	-f sub dif ply:ply_cut me1:me1_cut me2:me2_cut me3 me4 me5 me6 me7 \
	me8 alrdl Allgates - \
...
xn_12_hsl130e,	100000.0, 0,	xn_12_hsl130e,	unused, unused, 100000.0
n_12_hsl130e,	100000.0, 0,	n_12_hsl130e,	unused, unused, 100000.0
xp_12_hsl130e,	100000.0, 0,	xp_12_hsl130e,	unused, unused, 100000.0
p_12_hsl130e,	100000.0, 0,	p_12_hsl130e,	unused, unused, 100000.0
ENDCAT
...
xreduce -V -mergecap -n NET -tech \
	/usr/local/cadence6/G-9FD-MIXED_MODE_RFCMOS13-1P8M-MMC_FSG_L130E_UM130FDKMFC0000OA-FDK-Ver.A02_PB/RuleDecks/Assura/G-DF-LOGIC_MIXED_MODE13-1P8M2T-FSG_TOP_METAL8K_L130E_ASSURA-LPE-1.3-P4 \
	-d1 -decoupled -danglingR -minR 0.001 -rP \
	np_rply.res,np_rME1.res,np_rME2.res,mwires.res -cap capfile L1T0 \
	NG_HS_MOS_1.transr PG_HS_MOS_2.transr

#==========================================================#
# Generate HSPICE file
#==========================================================#

advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -nxref \
	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/dff.gnx \
	-dxref \
	/uwa_network_storage/shared/studentdata/ELEC/ELEC5503/Group-01/SmallPixel/myvirtuoso/Project_Lib1/dff/dff.gdx \
	-sc caps2dversion -m capfile -rPmw res.mod np_rply.res np_rME1.res \
	np_rME2.res -rPmw mwires.mod mwires.res -ta \
